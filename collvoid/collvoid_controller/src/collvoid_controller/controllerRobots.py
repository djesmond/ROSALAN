...
class ControllerRobots():
    ...
    def cb_common_positions(self,msg):
        #rospy.loginfo("GOT A NEW POSITION")
    ...
    def cb_commands_robot(self,msg):
        #print msg.data
        rospy.loginfo("SENT SOMETHING from %s, %s",self.hostname, msg.data)
